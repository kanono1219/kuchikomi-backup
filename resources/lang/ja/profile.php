...
return [
    'title' => 'プロフィール',
    'update_profile_information' => 'プロフィール情報の更新',
    'update_your_account' => 'アカウント情報を更新する',
    'name' => '名前',
    'email' => 'メールアドレス',
    'save' => '保存',
    'saved' => '保存しました。',
...
return [
    ...
    'update_password_description' => 'アカウントの安全性を保つため、ランダムで長いパスワードを使用してください。',
    'current_password' => '現在のパスワード',
    'new_password' => '新しいパスワード',
    'confirm_password' => '新しいパスワード（確認）',
    'delete_account' => 'アカウントの削除',
    'delete_account_description' => 'アカウントが削除されると、すべてのリソースとデータは完全に削除されます。アカウントを削除する前に、保持したいデータやリソースをダウンロードしてください。',
    'are_you_sure' => '本当にアカウントを削除しますか？',
    'delete_account_warning' => 'アカウントを削除すると、すべてのデータが完全に削除されます。',
    'cancel' => 'キャンセル',
];
...
<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('profile.update_your_account') }}
        </p>
    </header>
